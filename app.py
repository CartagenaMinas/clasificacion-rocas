...
###################### SiderBar ########################################
st.sidebar.title('MODELOS DE MACHING LEARNING PARA CLASIFICACIÓN DE ROCAS')
st.sidebar.markdown("<div style='text-align: justify'>Esta app esta enfocada a ser de guía básica clasificación de muestra de roca con la finalidad de crear un modelo para clasificar nuevas muestras. Para este ejemplo vamos a usar las técnicas de random forest, decision tree, logistic regression y support vector machine.</div>", unsafe_allow_html=True)
st.sidebar.title('Menú de opciones')
options = st.sidebar.radio('Seleccione una página:', 
    ['DECISION TREE','RANDOM FOREST','LOGISTIC REGRESSION',"SUPPORT VECTOR MACHINE","INFORMACIÓN"])
